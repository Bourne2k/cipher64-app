...
export function createFullLayout(): { [viewId: string]: JSX.Element } {
    return {
        [MOSAIC_PORTAL_IDS.LEFT]: <div id={MOSAIC_PORTAL_IDS.LEFT} className="h-full w-full" />,
        [MOSAIC_PORTAL_IDS.TOP_RIGHT]: <div id={MOSAIC_PORTAL_IDS.TOP_RIGHT} className="h-full w-full" />,
        [MOSAIC_PORTAL_IDS.BOTTOM_RIGHT]: <div id={MOSAIC_PORTAL_IDS.BOTTOM_RIGHT} className="h-full w-full" />,
    };
}

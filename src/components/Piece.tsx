...
export default function PieceComponent({
    ...
    // Replaced Mantine CSS variable with Shadcn's primary theme color
    const isSelected = !isDragging && selectedPiece && piece.role === selectedPiece.role && piece.color === selectedPiece.color;
        ...
        >
            <div
                ...
                style={{
                    ...
                    zIndex: 100,
                    backgroundColor: isSelected ? "hsl(var(--primary) / 0.25)" : "transparent",
                    borderRadius: "4px",
